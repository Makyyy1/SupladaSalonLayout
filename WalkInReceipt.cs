...
namespace SupladaSalonLayout
{
    public partial class WalkInReceipt : Form
    {
        ...
        public WalkInReceipt()
        {
            InitializeComponent();
        }

        private void WalkInReceipt_Load(object sender, EventArgs e)
        {
            DisplayReceipt();
        }
        ...
        private void DisplayReceipt()
        {
            ...
            {
                lblService1.Visible = false;
                lblService1Price.Visible = false;
            }
        ...
        private void PrintReceipt()
        {
            try
            {
                ...
                printDoc.PrintPage += new PrintPageEventHandler(printDocu_PrintPage);
        ...
        private void printDocu_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("WALK-IN RECEIPT", headerFont, Brushes.Black, leftMargin, yPos);
            yPos += 30;
